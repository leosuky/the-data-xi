...
def combine_dfs(home_path: str, away_path: str, combo_id: str, match_id: int) -> pd.DataFrame:

    home_path = pd.read_csv(home_path)
    away_path = pd.read_csv(away_path)
...
def combine_gk(home_path: str, away_path: str, combo_id: str, match_id: int) -> pd.DataFrame:
...
def shot_data(path: str, combo_id: str, match_id: int) -> pd.DataFrame:
