...
CREATE TABLE IF NOT EXISTS ws_team_poss_adv (
    ...
    avg_sequence_length             NUMERIC(5,1),
    avg_sequence_duration_s         NUMERIC(6,1),
    avg_sequence_start_x            NUMERIC(5,1),
    long_sequences                  INTEGER,
    long_seq_pct                    NUMERIC(5,1),
    shot_sequences                  INTEGER,
    shot_seq_pct                    NUMERIC(5,1),
    avg_shot_seq_length             NUMERIC(5,1),
    avg_shot_seq_duration_s         NUMERIC(6,1),
    avg_shot_seq_passes             NUMERIC(5,1),
    attack_sequences                INTEGER,
    avg_attack_duration_s           NUMERIC(6,1),
    avg_attack_passes               NUMERIC(5,1),
    counter_attack_sequences        INTEGER,
    counter_attack_shot_pct         NUMERIC(5,1),
    turnover_pct                    NUMERIC(5,1),
    set_piece_end_pct               NUMERIC(5,1),
    UNIQUE (combo_id, team_id)
);
